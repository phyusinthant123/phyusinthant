...
<div class="row tm-content-row tm-mt-big">
		  ...
		  <div class="bg-white tm-block h-100">
			 <h2>Thank You!! <?php echo "<font color=maroon>".@$_REQUEST['name']."</font>"; ?> </h2>
			 <br/>
			<b>Your order sent successfully!!!</b><hr>
			<b>Your order number is: <?php echo "<font color=maroon size=4><i>".@$_REQUEST['order_no']."</i></font>";?></b><hr>
			<b>Enjoy your shopping!</b><hr>
			<b>Thank you.Please come again.</b><hr>
		  ...
		  <footer class="row tm-mt-big">
           ...
           <div class="d-inline-block tm-bg-black text-white py-4 px-4">
               ...
               <a class="active" href="contact.php"><i class="fa fa-envelope"></i></a>              
