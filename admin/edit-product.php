                ...
                <div class="bg-white tm-block">
                    ...
                    <div class="row mt-4 tm-edit-product-row">
                        <div class="col-xl-7 col-lg-7 col-md-12">
                            <form  method="POST" action="update.php?id=<?php echo $id; ?>" class="tm-edit-product-form">
                                <div class="input-group mb-3">
                                    <label  for="name" class="col-xl-4 col-lg-4 col-md-4 col-sm-5 col-form-label">Product
                                        Name
                                    </label>
                                    <input  id="p_name" type="text" value="<?php echo $row['p_name']; ?>" name="p_name"  class="form-control validate col-xl-9 col-lg-8 col-md-8 col-sm-7">
                                </div>
								<div class="input-group mb-3">
                                    <label for="price" class="col-xl-4 col-lg-4 col-md-4 col-sm-5 col-form-label">Price</label>
                                    <input value="<?php echo $row['price']; ?>" name="price"  id="price"  type="text" class="form-control validate col-xl-9 col-lg-8 col-md-7 col-sm-7">
                                </div>
								<div class="input-group mb-3">
								...
								<div class="input-group mb-3">
                                    ...
                                    <input  value="<?php echo $row['exp_date']; ?>" name="date"  id="exp_date" type="text" class="form-control validate col-xl-9 col-lg-8 col-md-8 col-sm-7" data-large-mode="true">
                        ...
                        <div class="col-xl-4 col-lg-4 col-md-12 mx-auto mb-4">
                            <img src="image/edit-cakes.jpg" alt="Profile Image" class="img-fluid mx-auto d-block">
                            <img src="image/edit-cake1.jpg" alt="Profile Image" class="img-fluid mx-auto d-block">
