                            ...
                            echo"<table border='1'class='table table-hover table-striped tm-table-striped-even mt-3'>";
                                echo"<thead>";
                                   echo "<tr class='tm-bg-gray'>
										...
										<th scope='col'class='text-center'>fe_id</th>
                                ...
                                echo"</thead>";
								while(list($fe_id,$name,$email,$phone,$message)=mysql_fetch_array($val))
								{
                                echo"<tbody>";
                                    echo"<tr>";
                                        
										 echo"<td class='text-center'>".$fe_id."</td>";
                                        echo"<td class='text-center'>".$name."</td>";
                                       echo"<td class='text-center'>".$email."</td>";
                                        echo"<td class='text-center'>".$phone."</td>";								    
                                       echo"<td  class='text-center'>".$message."</td>";
                                       echo"<td class='text-center'>"."<a href='delete-fb.php?id=$fe_id'>"."<i class='fas fa-trash-alt tm-trash-icon'>"."</i><a/>"."</td>";
