                    ...
                    <div class="row mt-4 tm-edit-product-row">
                        <div class="col-xl-7 col-lg-7 col-md-12">
                            ...
                            <?php
                                ...
                                #$con=mysql_connect("localhost","root","")or die(mysql_error());3mysql_select_db("foods",$con);
                                ...
                                VALUES('','$p_name','$price','$p_img','$p_menus','$exp_date','$desc')";
                                mysql_query($query);
                                            
                                    if($query)			
                                    {
                                        mkdir("image/$p_img");
                                            move_uploaded_file($_FILES['p_img']['tmp_name'],"image/$p_img");	
                                        
                                        
                                    
                                        }
                                        $err="<font size='+2'>Your products inserted successfully.</font>";

                                    }  
                                    mysql_close($con);		

                            ?>
    <form action="add-product.php" class="tm-edit-product-form" method="post"enctype="multipart/form-data">
            <div class="input-group mb-3">
                <label for="name" name="name"class="col-xl-4 col-lg-4 col-md-4 col-sm-5 col-form-label">Product
                    Name
                </label>
            ...
            <div class="input-group mb-3">
                <label for="name" name="p_img"class="col-xl-4 col-lg-4 col-md-4 col-sm-5 col-form-label">Product
                    Image
                </label>
                <input id="name" name="p_img" type="file"   class="form-control validate col-xl-9 col-lg-8 col-md-8 col-sm-7">
            </div>

            <div class="input-group mb-3">
                <label for="price" name="price"class="col-xl-4 col-lg-4 col-md-4 col-sm-5 col-form-label">Price
                </label>
                <input id="price" name="price" type="text" class="form-control validate col-xl-9 col-lg-8 col-md-7 col-sm-7">
            </div>
            
            <div class="input-group mb-3">
                <label for="menu"  name="menus"class="col-xl-4 col-lg-4 col-md-4 col-sm-5 col-form-label">Category</label>
                <select name="menus"class="custom-select col-xl-9 col-lg-8 col-md-8 col-sm-7" id="category">
                    ...
                    while($row=mysql_fetch_array($query))
                    {
                        $m_id=$row['m_id'];
                        $m_title=$row['m_title'];
                        echo "<option value='$m_title'>".$m_title."</option>";
                    }
                    ?>
                </select>
            </div>
            ...
            <div class="input-group mb-3">
                <label for="description" name="desc"class="col-xl-4 col-lg-4 col-md-4 col-sm-5 mb-2">Description</label>
                <textarea name="desc"class="form-control validate col-xl-9 col-lg-8 col-md-8 col-sm-7" rows="3" required></textarea>
            </div>
            <div class="input-group mb-3">
                <label for="insert" class="col-xl-4 col-lg-4 col-md-4 col-sm-5 col-form-label">
            </div>
            <div class="input-group mb-3">
                <div class="ml-auto col-xl-8 col-lg-8 col-md-8 col-sm-7 pl-0">
                    <button type="submit" name="insert" class="btn btn-primary">Add
                         ...
                         <div class="col-xl-4 col-lg-4 col-md-12 mx-auto mb-4">
                            <img src="image/product-image.jpg" alt="Profile Image" class="img-fluid mx-auto d-block"><br/>
                            <img src="image/products-image.jpg" alt="Profile Image" class="img-fluid mx-auto d-block">
