...
?>
            ...
            <!-- row -->
			 ...
			 <h2>Welcome!! <?php echo "<font color=maroon>".@$_REQUEST['name']."</font>"; ?> </h2>
			 <br/>
			<b>You have created your account successfully!!!</b><hr>
			<b>Your UserID is: <?php echo "<font color=maroon size=4><i>".@$_REQUEST['email']."</i></font>";?></b><hr>
			<b>Enjoy your shopping!</b><hr>
			<b>Thank you.</b><hr>
			 <img src="img/bake.jpg" alt="Profile Image"width="300" height="300" class="img-fluid mx-auto d-block">
			<p><a href="login.php">Login</a></p><hr>
